...
int main() {
    ...
    // 2. 计算不同阶数的泰勒展开
    // 注意：这里的 n 对应你 Python 代码中的 range(n+1) 循环的最高阶次
    ...
    std::cout << "数值计算完成！数据已保存至 chap1/code/q3_data.csv" << std::endl;
